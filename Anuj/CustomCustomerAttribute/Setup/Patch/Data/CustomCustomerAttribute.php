<?php
namespace Anuj\CustomCustomerAttribute\Setup\Patch\Data;
...
class CustomCustomerAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'customer_phone_number', [
            'type' => 'varchar',
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'customer_phone_number')
        ->addData([
